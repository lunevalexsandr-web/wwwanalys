...
_CHAT_SYSTEM_PROMPT = (
    ...
    "ФОРМАТ ОТВЕТА: всегда начинай с блока «📌 Кратко:» — 2–4 пункта с главным "
    "(сколько отклонений, самое важное, что делать). После него, если нужно, дай "
    "подробности под заголовком «Подробно:». Если вопрос простой — можно только «Кратко:»."
)
